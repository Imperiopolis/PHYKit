...
UIStatusBarServerClient.hUIStatusBarStateObserver.h
@class NSMutableArray, NSNumber, NSString, UIColor, UILabel, UIStatusBarBackgroundView, UIStatusBarForegroundView, UIStatusBarServer, UIStatusBarStyleAnimationParameters, UIStatusBarStyleAttributes, UIStatusBarStyleRequest, UIStatusBarWindow;
...
@interface UIStatusBar : _UIScrollsToTopInitiatorView <UIStatusBarServerClient, UIStatusBarStateObserver>
{
    ...
    CDStruct_5c1a9c4d _currentRawData;
    ...
    CDStruct_d155c695 *_localDataOverrides;
    UIColor *_tintColor;
...
+ (int)lowBatteryLevel;
+ (void)getData:(CDStruct_5c1a9c4d *)arg1 forRequestedData:(const CDStruct_5c1a9c4d *)arg2 withOverrides:(const CDStruct_d155c695 *)arg3;
...
- (BOOL)_isTransparent;
- (id)_backgroundView;
- (void)statusBarStateProvider:(id)arg1 didPostStatusBarData:(const CDStruct_5c1a9c4d *)arg2 withActions:(int)arg3;
...
- (void)statusBarServer:(id)arg1 didReceiveStatusBarData:(const CDStruct_5c1a9c4d *)arg2 withActions:(int)arg3;
...
- (void)setLocalDataOverrides:(CDStruct_d155c695 *)arg1;
...
- (void)forceUpdateToData:(const CDStruct_5c1a9c4d *)arg1 animated:(BOOL)arg2;
