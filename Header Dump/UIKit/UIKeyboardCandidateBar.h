...
UICollectionViewDataSource.hUIKeyboardCandidateBarLayoutDelegate.hUIKeyboardCandidateList.hUIKeyboardCandidateListDelegate.h
...
@property(nonatomic) unsigned int previousInlineTextLength; // @synthesize previousInlineTextLength=_previousInlineTextLength;
