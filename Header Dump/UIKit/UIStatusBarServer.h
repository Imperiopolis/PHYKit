...
+ (CDStruct_d155c695 *)getStatusBarOverrideData;
+ (const CDStruct_5c1a9c4d *)getStatusBarData;
+ (void)permanentizeStatusBarOverrideData;
+ (void)postStatusBarOverrideData:(CDStruct_d155c695 *)arg1;
...
+ (void)postStatusBarData:(const CDStruct_5c1a9c4d *)arg1 withActions:(int)arg2;
...
- (void)_receivedStatusBarData:(CDStruct_5c1a9c4d *)arg1 actions:(int)arg2;
- (void)dealloc;
