...
@interface UIStatusBarServerThread : NSThread
{
    ...
    CDStruct_5c1a9c4d _statusBarData;
    CDStruct_5c1a9c4d _composedStatusBarData;
    CDStruct_d155c695 _overrides;
...
- (void)_postStatusBarOverrideData:(CDStruct_d155c695 *)arg1;
...
- (int)_styleOverrides;
- (void)_postStatusBarData:(CDStruct_5c1a9c4d *)arg1 actions:(int)arg2;
- (void)_broadcastStatusBarDataWithActions:(int)arg1;
- (CDStruct_d155c695 *)_statusBarOverrideData;
- (CDStruct_5c1a9c4d *)_statusBarData;
