...
UIActionSheetDelegate.hXPCProxyTarget.h_UIRemoteViewController_TextEffectsOperatorInterface.h_UIRemoteViewController_ViewControllerOperatorInterface.h
...
- (void)__viewServicePopoverDidChangeContentSize:(struct CGSize)arg1 animated:(BOOL)arg2 fenceSendRight:(id)arg3 withReplyHandler:(id)arg4;
