...
//=====================================================================
// To be removed soon: compatibility declarations for motion effect SPI -> API transition
NS_CLASS_AVAILABLE_IOS(7_0) @interface _UIMotionEffect : UIMotionEffect; @end
UIKIT_EXTERN const NSInteger _UIInterpolatingMotionEffectObservedMotionTypeTiltAlongHorizontalAxis;
UIKIT_EXTERN const NSInteger _UIInterpolatingMotionEffectObservedMotionTypeTiltAlongVerticalAxis;
NS_CLASS_AVAILABLE_IOS(7_0) @interface _UIInterpolatingMotionEffect : UIInterpolatingMotionEffect; @end
NS_CLASS_AVAILABLE_IOS(7_0) @interface _UIMotionEffectGroup : UIMotionEffectGroup; @end

@interface UIInterpolatingMotionEffect (DeprecatedSPI)
- (void)setKeyPath:(NSString *)keyPath;
@property (nonatomic) UIInterpolatingMotionEffectType observedMotionType;
@end
