...
- (UIView *)snapshotView NS_AVAILABLE_IOS(7_0);
- (UIView *)resizableSnapshotViewFromRect:(CGRect)rect withCapInsets:(UIEdgeInsets)capInsets NS_AVAILABLE_IOS(7_0); // Resizable snapshots will default to stretching the center
...
- (BOOL)drawViewHierarchyInRect:(CGRect)rect NS_AVAILABLE_IOS(7_0);
@end
